                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            <td style="text-align:center">
                                Alarm Start : {{changeDateformat($reports[0]->alarm->alarm_start_datetime)}}
                                <br />
                                Alarm End: {{changeDateformat($reports[0]->alarm->alarm_end_datetime)}}
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr style="text-align: left; border :none;padding:10px 0px">
                            <td style="text-align: left; border :none;font-size:12px;padding:0 0 5px 0px;">
                                <b style="padding:0px;margin:0px">
                                    {{$reports?$reports[0]->alarm->customer->building_name:'---'}}
                                </b>
                                <br>
                            </td>
                        </tr>
                        <tr style="text-align: left; border :none;padding:10px 0px">
                            <td style="text-align: left; border :none;font-size:10px;padding:5px 0px;">
                                <span style="margin-left: 3px">P.O.Box
                                    {{ $reports[0]->alarm->customer->house_number }},{{ $reports[0]->alarm->customer->street_number }}{{ $reports[0]->alarm->customer->area }} </span>
                                <br>
                            </td>
                        </tr>
                        <tr style="text-align: left; border :none;padding:10px 0px">
                            <td style="text-align: left; border :none;font-size:10px;padding:5px 0px">
                                <span style="margin-left: 3px">{{ $reports[0]->alarm->customer->city }}</span>
                                <br>
                            </td>
                        </tr>
                        <tr style="text-align: left; border :none;padding:10px 0px">
                            <td style="text-align: left; border :none;font-size:10px;padding:5px 0px">
                                <span style="margin-left: 3px">{{ $reports[0]->alarm->customer->state }}</span>
                                <br>
                            </td>
                        </tr>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $index+1 }}</td>
                    <td>{{ $item->security?$item->security->first_name:'---'   }} {{ $item->security?$item->security->last_name:'---'     }} </td>
                    <td>{{ $item->contact?$item->contact->first_name:'---'   }} {{ $item->contact?$item->contact->last_name:'---'   }} </td>
                    <td>{{ $item->contact?$item->contact->phone1:'---'   }} </td>
