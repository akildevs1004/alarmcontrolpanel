...
export default {
  ...
  created() {
    ...
    if (this.editId != "" && this.item) {
      this.payload_ticket.editId = this.editId;
      this.payload_ticket.user_id = this.item.user_id;
      this.payload_ticket.first_name = this.item.first_name;
      this.payload_ticket.last_name = this.item.last_name;
      this.payload_ticket.contact_number = this.item.contact_number;
      this.payload_ticket.email_id = this.item.user.email;
      this.web_login_access = this.item.user?.web_login_access || 0;
      this.payload_ticket.password = null;
