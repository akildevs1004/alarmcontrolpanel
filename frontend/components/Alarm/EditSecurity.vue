              ...
              <v-row class="pt-0">
                <v-col cols="6" dense>
                  <v-text-field
                    ...
                    outlined
                    type="text"
                    v-model="payload_security.first_name"
                    hide-details
                    :readonly="!editable"
                    :filled="!editable"
                  ></v-text-field>
                ...
                <v-col cols="6" dense>
                  <v-text-field
                    ...
                    outlined
                    type="text"
                    v-model="payload_security.last_name"
                    hide-details
                    :readonly="!editable"
                    :filled="!editable"
                  ></v-text-field>
                ...
                <v-col cols="6" dense>
                  <v-text-field
                    ...
                    outlined
                    type="number"
                    v-model="payload_security.contact_number"
                    hide-details
                    :readonly="!editable"
                    :filled="!editable"
                  ></v-text-field>
                ...
                <v-col cols="6" dense>
                  <v-text-field
                    ...
                    clearable
                    autocomplete="off"
                    v-model="payload_security.email_id"
                    hide-details
                    :readonly="!editable"
                    :filled="!editable"
                  ></v-text-field>
                  <span
                    v-if="primary_errors && primary_errors.email_id"
                    class="text-danger mt-2"
                ...
                <v-col cols="6" dense>
                  <v-text-field
                    ...
                    outlined
                    clearable
                    v-model="payload_security.password"
                    hide-details
                ...
                <v-col cols="6" dense>
                  <v-text-field
                    ...
                    clearable
                    :type="show1 ? 'text' : 'password'"
                    v-model="payload_security.confirm_password"
                    hide-details
                    :readonly="!editable"
                    :filled="!editable"
                  ></v-text-field>
