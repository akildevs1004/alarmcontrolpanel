              ...
              <v-col class="text-right" style="max-width: 1200px">
                ...
                ></v-text-field> -->
                  ...
                  <v-col
                    ...
                    "
                  >
                    <v-menu bottom style="z-index: 99999">
                    ...
                    >
                      ...
                      <v-menu>
                        ...
                        <v-list>
                          <v-list-item
                            @click="
                              showAlarmEvents(item.date, item.customer_id)
                            "
                            style="
                              min-height: 22px;
...
export default {
  ...
  methods: {
    ...
    downloadOptions(option) {
      ...
      if (option == "print") url += "/device_armed_report_print_pdf";
      if (option == "excel") url += "/device_armed_report_export_excel";
      if (option == "download") url += "/device_armed_report_download_pdf";
      url += "?company_id=" + this.$auth.user.company_id;
      url += "&date_from=" + this.date_from;
      url += "&date_to=" + this.date_to;
      if (this.customer_id) url += "&customer_id=" + this.customer_id;
      if (this.filter_customer_id)
        url += "&filter_customer_id=" + this.filter_customer_id;
      url += "&only_show_alarms=" + this.only_show_alarms;
