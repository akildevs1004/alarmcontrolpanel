    ...
    <v-row>
      <v-col cols="3" class="pr-0" style="max-width: 20%">
        <v-card class="elevation-2" style="height: 180px">
          <v-card-text>
            <AlarmBurglaryPieChart :key="key" :name="'AlarmBurglaryPieChart'"
          /></v-card-text>
        </v-card>
      </v-col>
      <v-col cols="3" class="pr-0" style="max-width: 20%">
        <v-card class="elevation-2" style="height: 180px">
          <v-card-text>
            <AlarmMedicalPieChart :key="key" :name="'AlarmMedicalPieChart'"
          /></v-card-text>
        </v-card>
      </v-col>
      <v-col cols="3" class="pr-0" style="max-width: 20%">
        <v-card class="elevation-2" style="height: 180px">
          <v-card-text>
            <AlarmWaterPieChart :key="key" :name="'AlarmWaterPieChart3'"
          /></v-card-text>
        </v-card>
      </v-col>
      <v-col cols="3" class="pr-0" style="max-width: 20%">
        <v-card class="elevation-2" style="height: 180px">
          <v-card-text>
            <AlarmFirePieChart :key="key" :name="'AlarmBFirePieChart4'"
          /></v-card-text>
        </v-card>
      </v-col>
